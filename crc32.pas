...
function GetFileCrc32(Filename: string): longword;
function AsmGetFileCrc32(Filename: string): longword;
function GetMemoryStreamCrc32(Stream: TMemoryStream): longword;
function AsmGetMemoryStreamCrc32(Stream: TMemoryStream): longword;
...
type
 TBuffer = array[0..50*1024*1024] of byte;
